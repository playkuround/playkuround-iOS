...
#Preview {
    SurviveGameView(viewModel: SurviveGameViewModel(rootViewModel: RootViewModel(), mapViewModel: MapViewModel(), storyViewModel: StoryViewModel(stories: storyList)), rootViewModel: RootViewModel())
}
